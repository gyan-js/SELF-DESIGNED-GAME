...
! function (t, e) {
    ...
    d.prototype.select = function (t, e) {
        ...
        var i, n = [],
            r = l(e);
        if (i = "." === t[0] ? (t = t.slice(1), r.getElementsByClassName(t)) : r.getElementsByTagName(t))
        ...
        if ("INPUT" !== t.tagName || "checkbox" !== t.type) return "VIDEO" === t.tagName || "AUDIO" === t.tagName ? new d.MediaElement(t, this) : "SELECT" === t.tagName ? this.createSelect(new d.Element(t, this)) : 0 < e.length && e.every(function (t) {
            return "INPUT" === t.tagName || "LABEL" === t.tagName
        }) ? this.createRadio(new d.Element(t, this)) : new d.Element(t, this);
    ...
    function i(t, e, i, n) {
        ...
        return a.loadedmetadata = !1, r.addEventListener("loadedmetadata", function () {
            a.width = r.videoWidth, a.height = r.videoHeight, 0 === a.elt.width && (a.elt.width = r.videoWidth), 0 === a.elt.height && (a.elt.height = r.videoHeight), a.presetPlaybackRate && (a.elt.playbackRate = a.presetPlaybackRate, delete a.presetPlaybackRate), a.loadedmetadata = !0
        }), a
        ...
        var e, i = arguments;
        return t.src = i[0], 1 < i.length && "string" == typeof i[1] && (t.alt = i[1]), t.onload = function () {
            e.width = t.offsetWidth || t.width, e.height = t.offsetHeight || t.height, 1 < i.length && "function" == typeof i[1] ? (e.fn = i[1], e.fn()) : 1 < i.length && "function" == typeof i[2] && (e.fn = i[2], e.fn())
        }, e = c(t, this)
        ...
        if (i.checked = function () {
            ...
            e.setAttribute("id", n), r.htmlFor = n, i.value(arguments[0]), r.appendChild(document.createTextNode(arguments[0])), t.appendChild(r)
        }
        ...
        return "object" == typeof e && "SELECT" === e.elt.nodeName ? (t = e, o = this.elt = e.elt) : (o = document.createElement("select"), e && "boolean" == typeof e && o.setAttribute("multiple", "true"), t = c(o, this)), t.option = function (t, e) {
            for (var i, n = 0; n < this.elt.length; n++)
                if (this.elt[n].innerHTML === t) {
                    i = n;
                    break
                } if (void 0 !== i) !1 === e ? this.elt.remove(i) : this.elt[i].innerHTML === this.elt[i].value ? this.elt[i].innerHTML = this.elt[i].value = e : this.elt[i].value = e;
            else {
                var r = document.createElement("option");
                r.innerHTML = t, 1 < arguments.length ? r.value = e : r.value = t, o.appendChild(r)
            }
        ...
        var r, n, e = document.querySelectorAll("input[type=radio]"),
            o = 0;
        if (1 < e.length)
            for (var i = e.length, s = e[0].name, l = e[1].name, a = o = 1; a < i; a++) s !== (l = e[a].name) && o++, s = l;
        else 1 === e.length && (o = 1);
        "object" == typeof t ? (n = t, r = this.elt = t.elt) : (r = document.createElement("div"), n = c(r, this)), n._getInputChildrenArray = function () {
            return Array.prototype.slice.call(this.elt.children).filter(function (t) {
                return "INPUT" === t.tagName
            })
        };
        var h = -1;
        return n.option = function (t, e) {
            var i = document.createElement("input");
            if (i.type = "radio", i.innerHTML = t, i.value = e || t, i.setAttribute("name", "defaultradio" + o), r.appendChild(i), t) {
                h++;
                var n = document.createElement("label");
                i.setAttribute("id", "defaultradio" + o + "-" + h), n.htmlFor = "defaultradio" + o + "-" + h, n.appendChild(document.createTextNode(t)), r.appendChild(n)
            }
            return i
        }, n.selected = function (t) {
            var e, i = n._getInputChildrenArray();
            if (t) {
        ...
        var e, i = document.createElement("input");
        return i.type = "color", t ? t instanceof d.Color ? i.value = t.toString("#rrggbb") : (d.prototype._colorMode = "rgb", d.prototype._colorMaxes = {
            rgb: [255, 255, 255, 255],
            hsb: [360, 100, 100, 1],
            hsl: [360, 100, 100, 1]
        }, i.value = d.prototype.color(t).toString("#rrggbb")) : i.value = "#000000", (e = c(i, this)).color = function () {
            return t.mode && (d.prototype._colorMode = t.mode), t.maxes && (d.prototype._colorMaxes = t.maxes), d.prototype.color(this.elt.value)
        }, e
        ...
        return this.elt.className ? this.hasClass(t) || (this.elt.className = this.elt.className + " " + t) : this.elt.className = t, this
        ...
        return this.elt.classList.contains(t) ? this.elt.classList.remove(t) : this.elt.classList.add(t), this
        ...
        var o = Math.abs(this.parent().offsetWidth - this.elt.offsetWidth),
            ...
            l = r.y,
            a = r.x;
        return "both" === t || void 0 === t ? this.position(o / 2, s / 2) : "horizontal" === t ? this.position(o / 2, l) : "vertical" === t && this.position(a, s / 2), this.style("display", e), i && this.hide(), n && (this.parent().style.display = "none"), this
        ...
        } else if (this.elt.style[t] = e, "width" === t || "height" === t || "left" === t || "top" === t) {
            var o = e.replace(/\D+/g, "");
        ...
        if (i !== r || n !== r) {
            if (i === r ? i = e * this.width / this.height : n === r && (n = t * this.height / this.width), this.elt instanceof HTMLCanvasElement) {
                ...
                for (o in l) s[o] = l[o];
                for (o in this.elt.setAttribute("width", i * this._pInst._pixelDensity), this.elt.setAttribute("height", n * this._pInst._pixelDensity), this.elt.style.width = i + "px", this.elt.style.height = n + "px", this._pInst.scale(this._pInst._pixelDensity, this._pInst._pixelDensity), s) this.elt.getContext("2d")[o] = s[o]
            } else this.elt.style.width = i + "px", this.elt.style.height = n + "px", this.elt.width = i, this.elt.height = n;
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            d.Element._attachListener("drop", function (t) {
        ...
        var r = this;
        this.elt.crossOrigin = "anonymous", this._prevTime = 0, this._cueIDCounter = 0, this._cues = [], (this._pixelsState = this)._pixelDensity = 1, this._modified = !1, this._pixelsDirty = !0, this._pixelsTime = -1, Object.defineProperty(r, "src", {
            get: function () {
    ...
    }, d.MediaElement.prototype.pixels = [], d.MediaElement.prototype._ensureCanvas = function () {
        this.canvas || this.loadPixels()
    }, d.MediaElement.prototype.loadPixels = function () {
        if (this.canvas || (this.canvas = document.createElement("canvas"), this.drawingContext = this.canvas.getContext("2d")), this.loadedmetadata) {
            this.canvas.width !== this.elt.width && (this.canvas.width = this.elt.width, this.canvas.height = this.elt.height, this.width = this.canvas.width, this.height = this.canvas.height, this._pixelsDirty = !0);
            var t = this.elt.currentTime;
            (this._pixelsDirty || this._pixelsTime !== t) && (this._pixelsTime = t, this._pixelsDirty = !0, this.drawingContext.drawImage(this.elt, 0, 0, this.canvas.width, this.canvas.height), d.Renderer2D.prototype.loadPixels.call(this))
        }
        return this.setModified(!0), this
    }, d.MediaElement.prototype.updatePixels = function (t, e, i, n) {
        return this.loadedmetadata && (this._ensureCanvas(), d.Renderer2D.prototype.updatePixels.call(this, t, e, i, n)), this.setModified(!0), this
        ...
        return d.Renderer2D.prototype._getPixel.apply(this, arguments)
    }, d.MediaElement.prototype.set = function (t, e, i) {
        this.loadedmetadata && (this._ensureCanvas(), d.Renderer2D.prototype.set.call(this, t, e, i), this.setModified(!0))
    ...
    d.MediaElement.prototype.addCue = function (t, e, i) {
        var n = this._cueIDCounter++,
            r = new o(e, t, n, i);
        return this._cues.push(r), this.elt.ontimeupdate || (this.elt.ontimeupdate = this._onTimeUpdate.bind(this)), n
